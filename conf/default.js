...
module.exports = {
	...
	admin: {
		...
		validEmails: ["ivandimanov1@gmail.com"],
	...
	session: {
		...
		encryptionKey: 'Y+1wcxK8Ks7dwZHLOuwua+t4pFueLqF38OR8GxdPed4=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'jELAnqDArF9JpDQbQRhjIxZqVdvLKFqnAgkzMb7djHQQIp36ujNIFdK2Q3KrA2tfuLcG37Z1EA7ovbNPXqModg==',
		secret: 'XoQ2p4wvp1jK89ira2IgpzlGNxo1TzDZ', // should be a large unguessable string
	...
	cookieSecret: 'EiNqlVnwgPKUrUC7SRJYT3HGQg0h/q0+',

	// your connector configuration goes here
	connectors: {
	},

	// Used for integrating Open Weather Map: https://openweathermap.org
	weatherApi: '42f3e35e4313df8e98a78b2820f8f2a6'
};
